package com.example.rrsystem.Controllers.Manager.ChangePassword;
...
@RestController
@RequestMapping("/api/manager/change-password")
public class ChangePasswordManagerController {
    ...
    public ChangePasswordManagerController(UpdatePersonelInfoARepository updatePersonelInfoARepository, JwtUtil jwtUtil, EmailService emailService, BCryptPasswordEncoder bCryptPasswordEncoder) {
