package com.example.rrsystem.Controllers.Admin.ChangePassword;
...
public class ChangePasswordAdminController {
    ...
    public ChangePasswordAdminController(UpdatePersonelInfoARepository updatePersonelInfoARepository, JwtUtil jwtUtil, EmailService emailService, BCryptPasswordEncoder bCryptPasswordEncoder) {
